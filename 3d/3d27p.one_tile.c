					...
					for (y = ymin; y < ymax; y++)
					{
						for (z = ZSLOPE; z < zup; z += veclen4)
						{
							...
							if (z == ZSLOPE)
							{
								...
								setload5(v1_backdown, v2_backdown, v3_backdown, v4_backdown, gw_backdown, C[t % 2][x - 1][y - 1][z]);
								vallset(v0_down, C[t % 2][x - 1][y][z - 1]);
								setload5(v1_down, v2_down, v3_down, v4_down, gw_down, C[t % 2][x - 1][y][z]);
								vallset(v0_frontdown, C[t % 2][x - 1][y + 1][z - 1]);
								setload5(v1_frontdown, v2_frontdown, v3_frontdown, v4_frontdown, gw_frontdown, C[t % 2][x - 1][y + 1][z]);
								vallset(v0_back, C[t % 2][x][y - 1][z - 1]);
								setload5(v1_back, v2_back, v3_back, v4_back, gw_back, C[t % 2][x][y - 1][z]);
								vallset(v0, C[t % 2][x][y][z - 1]);
								setload5(v1, v2, v3, v4, gw, C[t % 2][x][y][z]);
								vallset(v0_front, C[t % 2][x][y + 1][z - 1]);
								setload5(v1_front, v2_front, v3_front, v4_front, gw_front, C[t % 2][x][y + 1][z]);
								vallset(v0_backup, C[t % 2][x + 1][y - 1][z - 1]);
								setload5(v1_backup, v2_backup, v3_backup, v4_backup, gw_backup, C[t % 2][x + 1][y - 1][z]);
								vallset(v0_up, C[t % 2][x + 1][y][z - 1]);
								setload5(v1_up, v2_up, v3_up, v4_up, gw_up, C[t % 2][x + 1][y][z]);
								vallset(v0_frontup, C[t % 2][x + 1][y + 1][z - 1]);
								setload5(v1_frontup, v2_frontup, v3_frontup, v4_frontup, gw_frontup, C[t % 2][x + 1][y + 1][z]);
							}
							else
							{
								setload(v2_backdown, v3_backdown, v4_backdown, gw_backdown, C[t % 2][x - 1][y - 1][z + veclen]);
								setload(v2_down, v3_down, v4_down, gw_down, C[t % 2][x - 1][y][z + veclen]);
								setload(v2_frontdown, v3_frontdown, v4_frontdown, gw_frontdown, C[t % 2][x - 1][y + 1][z + veclen]);
								setload(v2_back, v3_back, v4_back, gw_back, C[t % 2][x][y - 1][z + veclen]);
								setload(v2, v3, v4, gw, C[t % 2][x][y][z + veclen]);
								setload(v2_front, v3_front, v4_front, gw_front, C[t % 2][x][y + 1][z + veclen]);
								setload(v2_backup, v3_backup, v4_backup, gw_backup, C[t % 2][x + 1][y - 1][z + veclen]);
								setload(v2_up, v3_up, v4_up, gw_up, C[t % 2][x + 1][y][z + veclen]);
								setload(v2_frontup, v3_frontup, v4_frontup, gw_frontup, C[t % 2][x + 1][y + 1][z + veclen]);
							}
							...
							{
								trans(v1, v2, v3, v4);
								trans(v1_front, v2_front, v3_front, v4_front);
								trans(v1_back, v2_back, v3_back, v4_back);
								trans(v1_up, v2_up, v3_up, v4_up);
								trans(v1_down, v2_down, v3_down, v4_down);
								trans(v1_frontup, v2_frontup, v3_frontup, v4_frontup);
								trans(v1_frontdown, v2_frontdown, v3_frontdown, v4_frontdown);
								trans(v1_backup, v2_backup, v3_backup, v4_backup);
								trans(v1_backdown, v2_backdown, v3_backdown, v4_backdown);
								if (x == XSLOPE)
								{
									setstore(v1_down, v2_down, v3_down, v4_down, C[0][x - 1][y][z]);
									if (y == YSLOPE)
									{
										setstore(v1_backdown, v2_backdown, v3_backdown, v4_backdown, C[0][x - 1][y - 1][z]);
									}
									else if (y == NY)
									{
										setstore(v1_frontdown, v2_frontdown, v3_frontdown, v4_frontdown, C[0][x - 1][y + 1][z]);
									}
								}
								else if (x == NX)
								{
									setstore(v1_up, v2_up, v3_up, v4_up, C[0][x + 1][y][z]);
									if (y == YSLOPE)
									{
										setstore(v1_backup, v2_backup, v3_backup, v4_backup, C[0][x + 1][y - 1][z]);
									}
									else if (y == NY)
									{
										setstore(v1_frontup, v2_frontup, v3_frontup, v4_frontup, C[0][x + 1][y + 1][z]);
									}
								}
								if (y == YSLOPE)
								{
									setstore(v1_back, v2_back, v3_back, v4_back, C[0][x][y - 1][z]);
								}
								else if (y == NY)
								{
									setstore(v1_front, v2_front, v3_front, v4_front, C[0][x][y + 1][z]);
								}
							}
							...
							shuffle_headd(v4_front, v0_front);
							shuffle_tail(v1_front, gw_front, v5_front);
							shuffle_headd(v4_back, v0_back);
							shuffle_tail(v1_back, gw_back, v5_back);
							shuffle_headd(v4_up, v0_up);
							shuffle_tail(v1_up, gw_up, v5_up);
							shuffle_headd(v4_down, v0_down);
							shuffle_tail(v1_down, gw_down, v5_down);
							shuffle_headd(v4_frontup, v0_frontup);
							shuffle_tail(v1_frontup, gw_frontup, v5_frontup);
							shuffle_headd(v4_frontdown, v0_frontdown);
							shuffle_tail(v1_frontdown, gw_frontdown, v5_frontdown);
							shuffle_headd(v4_backup, v0_backup);
							shuffle_tail(v1_backup, gw_backup, v5_backup);
							shuffle_headd(v4_backdown, v0_backdown);
							shuffle_tail(v1_backdown, gw_backdown, v5_backdown);
							...
							v0_down = v4_down;
							v1_down = gw_down;
							v0_frontup = v4_frontup;
							v1_frontup = gw_frontup;
							v0_frontdown = v4_frontdown;
							v1_frontdown = gw_frontdown;
							v0_backup = v4_backup;
							v1_backup = gw_backup;
							v0_backdown = v4_backdown;

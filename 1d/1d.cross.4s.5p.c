...
void cross_1d4s5p(double **A, double **R, int N, int T, int Bx, int tb)
{
	...
	for (tt = -tb; tt < T; tt += tb)
	{
		...
		{
			vec v1, v2, v3, v4, v5,v6,v7,v8,v9,v10,v11,v12,v13, v14, v15, v16,v17, v18, v19, v20;
			vec post1, post2;
			for (t = max(tt, 0); t < min(tt + 2 * tb, T); t+=4)
			{
				...
				for (x = xmin; x < xup; x +=veclen4)
				{
					if (x == xmin)
					{
						...
						setload(v13, v14, v15, v16, B[(t/2) % 2][x + 3*veclen4]);
						setload(v17, v18, v19, v20, B[(t/2) % 2][x + 4*veclen4]);
					}
					else
					{
						setload(v17, v18, v19, v20,B[(t/2) % 2][x+4*veclen4])
					...
					cross_cp_s4p5(v1, v2, v3, v4, v5, v6, v7,v8,v9,v10,v11,v12,v13, v14, v15, v16,v17, ww);
					cross_cp_s4p5(v2, v3, v4, v5, v6, v7,v8,v9,v10,v11,v12,v13, v14, v15, v16,v17,v18, ww);
					cross_cp_s4p5(v3, v4, v5, v6, v7,v8,v9,v10,v11,v12,v13, v14, v15, v16,v17,v18,v19 ,ww);
					cross_cp_s4p5(v4, v5, v6, v7,v8,v9,v10,v11,v12,v13, v14, v15, v16,v17,v18,v19,v20 ,ww);

					//trans(v1, v2, v3, v4);

					setstore(v1,v2,v3,v4,B[(t/2 + 1) % 2][x+2*veclen4]);

			...
			for (t = max(tt, 0); t < min(tt + 2 * tb, T); t+=2)
			{
				...
				for (x = xmin; x < xup; x +=veclen4)
				{
					if (x == xmin)
					{
						...
						setloadw(v6,v7,v8,v9,v10, B[(t/2) % 2][x + veclen5]);
						vload(v11,B[(t/2) % 2][x + 10*veclen]);
						vload(v12,B[(t/2) % 2][x + 11*veclen]);
					}
					else
					{
					...
					cross_cp_s2p5(v1, v2, v3, v4, v5, v6, v7,v8,v9, ww);
					cross_cp_s2p5(v2, v3, v4, v5, v6, v7, v8,v9,v10, ww);
					cross_cp_s2p5(v3, v4, v5, v6, v7, v8, v9,v10,v11, ww);
					cross_cp_s2p5(v4, v5, v6, v7, v8, v9, v10,v11,v12, ww);

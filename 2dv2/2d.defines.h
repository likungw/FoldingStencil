...
// added
#define compute_5p(a, b, c, d, e, kk) {b=_mm512_mul_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(a,b),c),d),e),kk);}
#define compute_5p_res(res, a, b, c, d, e, kk) {res=_mm512_mul_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(a,b),c),d),e),kk);}
#define computed_9p(a, b, c, d, e, f, g, h, i, ww, kk) {a=_mm512_mul_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(a,b),c),d),e),f),g),h),i),kk);}
#define compute_9p(a, b, c, d, e, f, g, h, i, ww, kk) {d=_mm512_mul_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(_mm512_add_pd(a,b),c),d),e),f),g),h),i),kk);}

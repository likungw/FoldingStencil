			...
			for (t = max(tt, 0); t < min(tt + 2 * tb, T); t++)
			{
				...
				for (x = xmin; x < xup; x += 4)
				{
					for (y = ymin; y < yup; y += veclen4)
					{
						...
						setload(v61, v62, v63, v64, C[t % 2][x + 4][y]);
						...
						v40 = v44;
						compute2_5p(v41, v50, v51, v52, v61, ww, kk);
						compute2_5p(v42, v51, v52, v53, v62, ww, kk);
						compute2_5p(v43, v52, v53, v54, v63, ww, kk);
						compute2_5p(v44, v53, v54, v55, v64, ww, kk);
						...
						// store
						setstore(v11, v12, v13, v14, C[(t + 1) % 2][x][y]);
						setstore(v21, v22, v23, v24, C[(t + 1) % 2][x + 1][y]);
						setstore(v31, v32, v33, v34, C[(t + 1) % 2][x + 2][y]);
						setstore(v41, v42, v43, v44, C[(t + 1) % 2][x + 3][y]);

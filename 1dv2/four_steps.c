		...
		for(xx = 0; xx <nb0[level]; xx++) {
			...
			for(t= max(tt, 0) ; t <min( tt + 2*tb,  T); t++){
				...
				if((tt == -tb)||(tt == T-tb)){
					...
					vec va40, vb10, va11, va71, va41, va81,va12, va22, va32, va42, va52, va62, va72, va82, zero;
					...
					for (x = xmin; x < xup; x+=veclen8) {
						if(x == xmin){
							...
							setload(v1,v2,v3,v4,v5,v6,v7,v8,B[1-level][xmin]);
							setloadw(w1,w2,w3,w4,w5,w6,w7,w8,gw,B[1-level][xmin]);
						}
						else{								
							setload(v2,v3,v4,v5,v6,v7,v8,gw,B[1-level][x+veclen]);
						}
						...
						if(x > xmin){
							...
							shuffle_head(w8,v8,zero);	
							shuffle_tail(v1,w1,v9);
							shuffle_tail(w1,gw,w9);
						}						
						setcompute(v0,v1,v2,v3,v4,v5,v6,v7,v8,v9,ww,kk);							
						if(x == xmin){							
							setcompute(zero,w1,w2,w3,w4,w5,w6,w7,w8,w9,ww,kk);	
							w40 = w4;
							w41 = w3;
							w11 = zero;
							w31 = w2;
							if((xx == 0)&&(level == 1)){	
								...
								//left1 = D0(v0);							
								vallset(v8,B[1-level][xmin-2]);								
							}			
							shuffle_headd(v3,v4);			
							shuffle_head(w3,v3,w4);	
							shuffle_tail(v0,zero,v5);
							setcompute(v4,v0,v1,v2,v3,v5,v6,v7,v8,v9,ww,kk);								
							...
							setcompute(v3,v4,v0,v1,v2,v5,v6,v7,v8,v9,ww,kk);
							k1 = v3;
							k2 = v4;
							k3 = v0;
							k4 = v1;
							...
							setcompute(w4,w1,w2,w3,w4,w5,w6,w7,w31,w5,ww,kk);
							w31 = v2;	
							w40 = v4;
							w41 = v3;
							w11 = v0;							
							...
							setcompute(k0,k1,k2,k3,k4,k5,k6,k7,k8,k9,ww,kk);	
							if(tt == T-2*tb){
								trans(k0,k1,k2,k3,k4,k5,k6,k7);
							}
							setstore(k0,k1,k2,k3,k4,k5,k6,k7,B[1-level][x-veclen8*2]);
							k0 = k4;
							k1 = w3;
							k2 = w4;
							k3 = zero;
					...
					shuffle_tail(w11,gw,w5);
					shuffle_tail(w1,v4,w5);	
					setcompute(w4,w1,w2,w3,w31,w5,w6,w7,w8,w9,ww,kk);
					...
					setstore(k0,k1,k2,k3,k4,k5,k6,k7,B[1-level][x-veclen8]);
					shuffle_head(w3,k4,w31);
					shuffle_tail(k1,w3,k5);
                    setcompute(w31,w4,w1,w2,w3,w5,w6,w7,w8,k5,ww,kk);
                    if(tt == T-2*tb){
						trans(k0,k1,k2,k3,k4,k5,k6,k7);
					}
					setstore(w31,w4,w1,w2,w3,w5,w6,w7,B[1-level][x]);

...
void two_tiles(double** A, double** R, int N, int T, int Bx, int tb){
	...
	for (tt = -tb; tt < T ;  tt += tb ){
		#pragma omp parallel for private(xmin,xmax,t,x,xe,xx,ww,kk)
		for(xx = 0; xx <nb0[level]; xx++) {
			vec v0,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10;
			vec w0,w1,w2,w3,w4,w5,w6,w7,w8,w9;
			vec pre1,pre2,pre3,pre4,post1,post2; 
			double left,right;			
			for(t= max(tt, 0) ; t <min( tt + 2*tb,  T); t+=2){
				...
				if((tt == -tb)||(t >= tt + tb)){					
					...
					for(x = xmin; x < xe; x+=veclen8){
						if(x == xmin){					
							setloadw(v1,v2,v3,v4,v5,v6,v7,v8,v9,B[(t/2)%2][x-1]);
						}
						else{
						...
						//post2 = tail2(v2,v9);
						shuffle_tail(v2,v9,post2);
						setcompute(v1,v2,v3,v4,v5,v6,v7,v8,post1,post2,ww,kk); 
						if(x == xmin){
							if(x == 1){
							...
							setcompute(w1,w2,w3,w4,w5,w6,w7,w8,post1,post2,ww,kk);							
					...
					for(x = xmin; x < xe; x+=veclen8){
						...
						if(x == xmin ){
							//pre2 = head2(v7,pre2);
							shuffle_head2(v7,pre2,pre2);
						}
						else{
							//pre2 = head1(v7,pre2);
							shuffle_head(v7,pre2,pre2);
						}		
						setcompute(pre2,pre1,v1,v2,v3,v4,v5,v6,v7,v8,ww,kk);
						if(x == xmin ){
						...
						setcompute(pre4,pre3,pre2,pre1,v1,v2,v3,v4,v5,v6,ww,kk);
						if(x == 1){
							//pre4 = boundary(pre4);
